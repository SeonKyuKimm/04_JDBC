...
public class EmployeeView {
	...
	public void displayMenu() {
		...
		do {
			...
			try {
				...
				input = -1; // 반복문 첫 번째 바퀴에서 잘못 입력하면 종료되는 상황 방지용
				sc.nextLine(); // 입력버퍼에 남아있는 잘못 입력된 문자열 제거해서 무한반복을 방지.
	...
	public void insertEmployee() throws Exception {
		...
		Employee emp = new Employee(empId, empName, empNo, email, phone, deptCode, jobCode, salary, deptCode, jobCode,
	...
	public void selectEmpId() throws Exception {
		...
		// 사번 입력 받기 ( 보조메서드에 input EmpId() 이용 )
		int empId = inputEmpId();
