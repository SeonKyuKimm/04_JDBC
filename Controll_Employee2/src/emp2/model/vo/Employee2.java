...
public class Employee2 {
	...
	// 매개변수 생성자
	public Employee2(int empId, String empName, String empNo, String email, String phone, String departmentTitle,
	...
	public String toString() {
		return "Employee2 [empId=" + empId + ", empName=" + empName + ", empNo=" + empNo + ", email=" + email
